    ...
    <div className="profile-dropdown" ref={dropdownRef}>
      ...
      {isOpen && (
        <div className="dropdown-menu">
          <NavLink className="dropdown-menu-navlink" to="/mina-sidor" onClick={() => setIsOpen(false)}>
            <svg
                width="18px"
                height="18px"
                viewBox="0 0 64 64"
