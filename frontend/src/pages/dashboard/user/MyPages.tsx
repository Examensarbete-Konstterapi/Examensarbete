...
export function MyPages() {
  const [activeTab, setActiveTab] = useState<"profile" | "bookings" | "courses">("profile");
        ...
        <section className="my-pages-section">
            ...
            <IconButton
              ...
              icon={
                <svg 
                  ...
                  <g id="SVGRepo_iconCarrier"> <g id="Interface / Book_Open"> 
                  ...
                  stroke="#597059" strokeWidth="0.9600000000000002" strokeLinecap="round" strokeLinejoin="round"></path> </g> </g></svg>
              }
            />
            <IconButton
              onClick={logout}
              ...
              viewBox="0 0 471.2 471.2" >
                ...
                <g id="SVGRepo_iconCarrier"> <g> <g> 
                  ...
                  <path d="M450.019,226.1l-85.8-85.8c-5.3-5.3-13.8-5.3-19.1,0c-5.3,5.3-5.3,13.8,0,19.1l62.8,62.8h-273.9c-7.5,0-13.5,6-13.5,13.5 s6,13.5,13.5,13.5h273.9l-62.8,62.8c-5.3,5.3-5.3,13.8,0,19.1c2.6,2.6,6.1,4,9.5,4s6.9-1.3,9.5-4l85.8-85.8 C455.319,239.9,455.319,231.3,450.019,226.1z"></path> </g> </g> </g>
                  </svg>
            }
            label="Logga ut"
            />
          ...
          <div className="settings">
            <div className="heading">
              <h2>{activeTab === "profile" ? "Profilinformation" : activeTab === "courses" ? "Mina kurser" : "Mina bokningar"}</h2>
              <RegularButton
                onClick={() => {}}
                label="Redigera"
                size="sm"
